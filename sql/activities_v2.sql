...
CREATE TABLE `activity` (
  ...
  `title` varchar(256) CHARACTER SET utf8 NOT NULL COMMENT '活动标题',
  `remark` text CHARACTER SET utf8 COMMENT '活动描述',
  ...
  `addr` varchar(256) CHARACTER SET utf8 DEFAULT NULL COMMENT '活动地址',
...
CREATE TABLE `activity_user` (
  ...
  `alias` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT '报名昵称',
...
CREATE TABLE `group` (
  ...
  `name` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT '群组名称',
  `logo` varchar(256) CHARACTER SET utf8 DEFAULT NULL COMMENT '群组LOGO',
  `notice` text CHARACTER SET utf8 COMMENT '群组公告',
  `addr` varchar(256) CHARACTER SET utf8 DEFAULT NULL COMMENT '群组总部地址',
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  `delete_at` datetime DEFAULT NULL COMMENT '删除时间',
  PRIMARY KEY (`id`),
...
CREATE TABLE `group_member` (
  ...
  `alias` varchar(50) CHARACTER SET latin1 NOT NULL DEFAULT '' COMMENT '群组中别名',
  `avator` varchar(128) CHARACTER SET latin1 DEFAULT NULL COMMENT '头像',
...
CREATE TABLE `user` (
  ...
  `password` varchar(128) CHARACTER SET utf8 NOT NULL DEFAULT '123456' COMMENT '密码',
  `scores` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '积分',
  `token` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT 'token',
  `wx_token` varchar(128) CHARACTER SET utf8 NOT NULL COMMENT '微信session_key',
  `wx_nick` varchar(256) CHARACTER SET utf8 NOT NULL COMMENT '微信昵称',
  `nick` varchar(256) CHARACTER SET utf8 NOT NULL COMMENT '昵称',
  ...
  `ip` varchar(128) CHARACTER SET utf8 DEFAULT '0' COMMENT 'ip地址',
