...
func handleGetByID(c *fiber.Ctx) error {
	...
	if err != nil {
		return core.Push(c, constant.ErrActivityNotFound)
	}
...
func handleGetByUserID(c *fiber.Ctx) error {
	...
	if err != nil {
		return core.Push(c, constant.ErrActivityGetData)
	}
...
// 	if err != nil {
// 		return Push(c, constant.ErrActivityGetData)
// 	}
...
func handleGetByPage(c *fiber.Ctx) error {
	...
	pageSize := c.QueryInt("page_size", constant.PAGE_SIZE)
...
func handleCreate(c *fiber.Ctx) error {
	...
	if err != nil {
		return core.Push(c, constant.ErrActivityCreate)
	}
...
func handleApply(c *fiber.Ctx) error {
	...
	if err != nil {
		return core.Push(c, constant.ErrActivityApply)
	}
...
func handleRemove(c *fiber.Ctx) error {
	...
	// 	return core.Push(c, constant.ErrActivityUpdate)
	// }
	return core.Ok(c, nil)
}
